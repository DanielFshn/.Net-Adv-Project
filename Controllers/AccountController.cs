    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    fileName = "~/UserPhotos/" + Guid.NewGuid() + "_" + model.Photo.FileName;
                    model.Photo.SaveAs(Server.MapPath(fileName));
                   // user.Photo = fileName;
                }
                catch (Exception e)
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    //{
                    //{
                    //    Photo.SaveAs(HttpContext.Server.MapPath("~/UserPhotos/") + Photo.FileName);
